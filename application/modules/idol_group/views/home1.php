                ...
                echo "
                  <div class='col-sm-12 col-md-4 mb-sm-60 text-left sm-text-center'>
                    <div class='volunteer border bg-white-fa mb-30 p-30'>
                      <div class='thumb'><img alt='' src='{$base}assets/uploads/$row->logo_idol_group' class='img-fullwidth' height='200px'></div>
                      <div class='info'>
                        <h4 class='name'><a href='".site_url('idol_group/group/')."$row->id_idol_group'>$row->nama_idol_group</a></h4>
                      </div>
                    </div>
                  </div>
                ";
