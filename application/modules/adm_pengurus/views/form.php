<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box panel-saya">
            ...
            <!-- /.box-header -->
            <?= form_open_multipart('adm_pengurus/tambah'); ?>
            <div class="box-body">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <input type="email" class="form-control" placeholder="cth: melo@mail.jkt..." id="email_akun" name="email_akun" value="<?= set_value('email_akun'); ?>">
                    </div>
                </div>
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input type="text" class="form-control" name="link_twitter_akun" value="<?= set_value('link_twitter_akun'); ?>" placeholder="cth: @officialjkt48..." style="color: #00aced;">
                            <div class="input-group-addon">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="keanggotaan">
                            <option value="Anggota">-----Pilih-----</option>
