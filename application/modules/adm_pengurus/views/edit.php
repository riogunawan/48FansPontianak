        ...
        <div class="box panel-saya">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" placeholder="cth: Melo..." id="pw_akun" name="pw_akun">
                    </div>
                </div>
                <div class="form-group col-sm-12">
                ...
                <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <input type="email" class="form-control" placeholder="cth: melo@mail.jkt..." id="email_akun" name="email_akun" value="<?= $detail->email_akun; ?>">
                    </div>
                </div>
                <div class="form-group col-sm-12">
                ...
                <div class="form-group col-sm-12">
                    <div class="col-sm-2">
                        ...
                        <a href="<?= site_url('adm_pengurus/editfoto/').$detail->id_akun ?>" class="btn btn-info">Edit Foto</a>
                    </div>
                    <div class="col-sm-4">
                        <img src="<?= base_url() ?>assets/uploads/<?= $detail->foto_akun; ?>" alt="Tidak Ada Foto" class="img-responsive"><br>
                    </div>
                    <label class="col-sm-2 control-label">Keanggotaan</label>
                    <div class="col-sm-4">
                        <select class="form-control" name="keanggotaan">
                            <option value="<?= $detail->keanggotaan; ?>">----<?= $detail->keanggotaan; ?>----</option>
                            <option value="Founder">Founder</option>
                            <option value="Ketua Komunitas">Ketua Komunitas</option>
            ...
            <div class="box-footer">
                <center><input type="button" value="Kembali" onclick="history.back(-1)" class="btn btn-orange" />&nbsp;<button type="submit" class="btn btn-lg btn-success" name="edit" value="edit">Edit</button></center>
            </div>
            <?= form_close(); ?>
        </div>
        <!-- /.box -->
