    ...
    <div class="col-md-12">
        ...
        <div class="box panel-saya">
            ...
            <div class="box-body table-responsive">
                ...
                <div class="">
                    <?= form_open_multipart(); ?>
                        <input type="hidden" value="<?= $list->row('no_memesan'); ?>" name="no_memesan" />
                            <!-- FOTO -->
                            <div class="form-group col-sm-12">
                                <label class="col-xs-12 col-sm-3 control-label" style="font-size: 25px; color: #555;">Upload Resi</label>
                                <div class="col-xs-12 col-sm-3">
                                    <input name="foto" type="file" class="form-control inline btn btn-primary" data-label="<i class='glyphicon glyphicon-file'></i> Browse" style="left: -1.25px; top: 14.5px;">
                                </div>
                        ...
                        <div class="box-footer">
                            <center><input type="button" value="Go Back" onclick="history.back(-1)" class="btn btn-warning" />&nbsp;<button type="submit" class="btn btn-primary" name="submit" value="submit">Submit</button></center>
                        </div>
                        <?= form_close(); ?>
                </div>
