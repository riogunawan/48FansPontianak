                            ...
                            <?php
                             ...
                             ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="pw_re-type" class="col-sm-2 control-label">Re-type Password</label>
                                    <div class="col-sm-4">
                                        <input type="password" class="form-control" id="pw_re-type" placeholder="ex: 48fansptk" name="pw_re-type" value="<?= set_value('pw_re-type'); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="email" class="form-control" id="email_akun" placeholder="ex: riogunawan29@gmail.com" name="email_akun" value="<?= set_value('email_akun'); ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-10 col-sm-5">
                                        <div class="form-control dropzone" id="my-dropzone" style="width: 200px; color: #555; height: auto;">
                                        </div>
                                        <?php
                                            $hidden2_attr = array(
                                                'type' => 'hidden',
