    ...
    <div class="col-md-12">
        ...
        <div class="box panel-saya">
            ...
            <div class="box-footer">
                <center><input type="button" value="Go Back" onclick="history.back(-1)" class="btn btn-warning" />&nbsp;<button type="submit" class="btn btn-primary" name="edit" value="edit">Edit</button></center>
            </div>
            <?= form_close(); ?>
        </div>
        <!-- /.box -->
